...
if (type.toLocaleLowerCase() === 'yes' || type.toLocaleLowerCase() === 'y')
{
  ...
  { alert("you guessed that, Iam not ");}
  ...
  { alert("you guessed that, Iam still a student ");}
  ...
  { alert("exactly, I prefer the in store shopping mode");}
  ...
  { alert("yeah, it is not my favourite one");}
  ...
  { alert("you didn't guess that, actually I prefer it");}
}
